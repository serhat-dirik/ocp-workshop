...
#### Using application code on embedded Gogs

OpenShift can work with any accessible Git repository. This could be Gogs,
GitLab, or any other server that speaks Git. You can even register webhooks in
your Git server to initiate OpenShift builds triggered by any update to the
application code!

In this example we're going to use Gogs that is previously installed for you.
Go to the given url below and login with your credentials.
...
[NOTE]
====
Your Gogs credentials are: *{{GOGS_USER}}/{{GOGS_PASSWORD}}*
====

### Exercise: Cloning your own project
The repository that we are going to use need to be cloned into your user space.
Later in the lab, we want you to make a code change and then rebuild your
application. This is a fairly simple Spring framework Java application. You need
to switch to "Mirror" tab to clone project source code and click on the "blue plus"
icon on the top right corner.

image::gogs-mirror.png[Clonning]

On the "New Migration" form, you need to specify the clone address as below:name:
[source,role=copypaste]
----
{{NATIONALPARKS_GIT_URL}}
----

Pick "nationalparks" as your new repository name and make sure that "This repository
will be a mirror" checkbox is unchecked.

image::gogs-new-migration.png[Clonning]

Click on the "Migrate Repository" button and wait until Gogs clone the original
repository for you.
...
[source,role=copypaste]
----
{{GOGS_URL}}/{{GOGS_USER}}/nationalparks.git
----
...
`http://nexus-tk.app.hyperidea.com/content/groups/public/`
