...
Gogs, or any other server that speaks Git. You can even register webhooks in
your Git server to initiate OpenShift builds triggered by any update to the
application code!

The repository that we are going to use is already cloned in the internal git repository
and located at the following URL:

[source,role=copypaste]
----
{{GOGS_URL}}/{{GOGS_USER}}/nationalparks/src/{{NATIONALPARKS_VERSION}}
----
